<template>
  <div class="modal fade show" id="productModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-modal="true" ref="modal">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content border-0">
        <div class="modal-header bg-dark text-white">
          <h5 class="modal-title" id="exampleModalLabel"><span>編輯貼文</span></h5>
          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <div class="row gx-1 mb-3">
                <div class="col-md-2 mb-1" v-for="(tag, key) in tempArticle.tag"
                  :key="`tag-${key}`">
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control" id="description" placeholder="請輸入文章描述"
